          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeUp delay={0.2}>
              <div className="relative flex items-center justify-center py-6 sm:py-8">
                ...
                <div className="relative w-full max-w-[310px] sm:max-w-[340px] bg-white rounded-3xl shadow-2xl shadow-black/40 overflow-hidden border border-volcan-taupe/20 sm:rotate-2 hover:rotate-0 transition-all duration-500 z-10">
                  {/* Header */}
                  ...
                  {/* Content: Imagen recortada a 4:5 oficial de Instagram (524x655) */}
                  <div className="aspect-[4/5] bg-white relative overflow-hidden group border-y border-gray-100">
                    <img
