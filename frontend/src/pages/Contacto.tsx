        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeUp>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-volcan-stone/80 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-3">
              <FadeUp delay={0.1}>
                {isSuccess ? (
                  <div className="bg-white rounded-3xl p-10 text-center border border-volcan-sand shadow-sm h-full flex flex-col justify-center items-center">
                    <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mb-6">
                      <CheckCircle className="text-green-600" size={40} />
                    </div>
                    <h3 className="text-3xl font-serif font-bold text-volcan-night mb-4">¡Mensaje enviado!</h3>
                    <p className="text-lg text-volcan-stone/80 mb-8">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-volcan-sand space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-volcan-stone mb-2">Nombre completo *</label>
                        <input
                          {...register('nombre', { required: 'El nombre es obligatorio', minLength: { value: 2, message: 'Mínimo 2 caracteres' } })}
                          className={`w-full px-4 py-3 rounded-xl border bg-volcan-cream/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-volcan-ember/50 transition-colors ${errors.nombre ? 'border-red-500' : 'border-volcan-sand'}`}
                          placeholder="Juan Pérez"
                        />
                        {errors.nombre && <p className="mt-1 text-sm text-red-500">{errors.nombre.message}</p>}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-volcan-stone mb-2">Email *</label>
                        <input
                          type="email"
                          {...register('email', { required: 'El email es obligatorio', pattern: { value: /^\S+@\S+$/i, message: 'Email inválido' } })}
                          className={`w-full px-4 py-3 rounded-xl border bg-volcan-cream/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-volcan-ember/50 transition-colors ${errors.email ? 'border-red-500' : 'border-volcan-sand'}`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-volcan-stone mb-2">Teléfono / WhatsApp</label>
                        <input
                          {...register('telefono')}
                          className="w-full px-4 py-3 rounded-xl border border-volcan-sand bg-volcan-cream/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-volcan-ember/50 transition-colors"
                          placeholder="+54 9 11 1234-5678"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-volcan-stone mb-2">Nombre de tu negocio / web</label>
                        <input
                          {...register('negocio')}
                          className="w-full px-4 py-3 rounded-xl border border-volcan-sand bg-volcan-cream/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-volcan-ember/50 transition-colors"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-volcan-stone mb-2">Plan de interés</label>
                      <select
                    ...
                    <div>
                      <label className="block text-sm font-medium text-volcan-stone mb-2">Mensaje *</label>
                      <textarea
                        rows={4}
                        ...
                        className={`w-full px-4 py-3 rounded-xl border bg-volcan-cream/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-volcan-ember/50 transition-colors resize-none ${errors.mensaje ? 'border-red-500' : 'border-volcan-sand'}`}
            ...
            <div className="lg:col-span-2 space-y-8">
              <FadeUp delay={0.2}>
                <div className="bg-volcan-night text-volcan-sand rounded-3xl p-8 lg:p-10 shadow-lg">
                  ...
                  <ul className="space-y-6">
                    <li>
                      <a href="https://wa.me/5492216743529" target="_blank" rel="noreferrer" className="flex items-start gap-4 hover:text-white group transition-colors">
                        <div className="w-12 h-12 bg-volcan-stone/30 rounded-full flex items-center justify-center shrink-0 group-hover:bg-volcan-ember transition-colors">
                          <Phone size={20} className="text-volcan-sand group-hover:text-volcan-night" />
                        </div>
                        <div>
                          <div className="text-sm text-volcan-sand/70 mb-1">WhatsApp</div>
                    ...
                    <li>
                      <a href="mailto:info@volcandigital.com.ar" className="flex items-start gap-4 hover:text-white group transition-colors">
                        <div className="w-12 h-12 bg-volcan-stone/30 rounded-full flex items-center justify-center shrink-0 group-hover:bg-volcan-ember transition-colors">
                          <Mail size={20} className="text-volcan-sand group-hover:text-volcan-night" />
                        </div>
                        <div>
                          <div className="text-sm text-volcan-sand/70 mb-1">Email</div>
                    ...
                    <li>
                      <a href="https://instagram.com/volcan.digital" target="_blank" rel="noreferrer" className="flex items-start gap-4 hover:text-white group transition-colors">
                        <div className="w-12 h-12 bg-volcan-stone/30 rounded-full flex items-center justify-center shrink-0 group-hover:bg-volcan-ember transition-colors">
                          <Instagram size={20} className="text-volcan-sand group-hover:text-volcan-night" />
                        </div>
                        <div>
                          <div className="text-sm text-volcan-sand/70 mb-1">Instagram</div>
                    ...
                    <li>
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-volcan-stone/30 rounded-full flex items-center justify-center shrink-0">
                          <MapPin size={20} className="text-volcan-sand" />
                        </div>
                        <div>
                          <div className="text-sm text-volcan-sand/70 mb-1">Ubicación</div>
              ...
              <FadeUp delay={0.3}>
                <div className="rounded-3xl overflow-hidden shadow-sm h-64 bg-volcan-stone/10 border border-volcan-sand">
                  {/* Google Maps Embed */}
                  <iframe 
